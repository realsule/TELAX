...
import { Sprout, Droplets, Sun, MapPin, Users, Star, Heart, Filter, Search } from 'lucide-react'
...
export function Explore() {
  ...
  const categories = [
    ...
    { id: 'poultry', name: 'Poultry', icon: Users },
    { id: 'hydroponics', name: 'Hydroponics', icon: Droplets },
    { id: 'grain', name: 'Grain', icon: Sun },
    { id: 'vegetables', name: 'Vegetables', icon: Sprout },
    { id: 'dairy', name: 'Dairy', icon: Heart },
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredFarms.map(farm => {
            const Icon = getCategoryIcon(farm.category)
            return (
              <div key={farm.id} className="glass-card hover:shadow-xl transition-all duration-300 group">
                ...
                <div className="space-y-4">
                  <div className="flex items-start justify-between">
                    <div>
                      <h3 className="text-xl font-bold text-forest-900 dark:text-forest-100 mb-2 group-hover:text-forest-600 transition-colors">
                        {farm.name}
                      </h3>
